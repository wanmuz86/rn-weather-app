...
import { StyleSheet, Text, View, ImageBackground, TouchableOpacity, SafeAreaView, TextInput, ActivityIndicator, Image } from 'react-native';
export default function Home() {
    const [isLoading, setIsLoading] = useState(false); //must for API
